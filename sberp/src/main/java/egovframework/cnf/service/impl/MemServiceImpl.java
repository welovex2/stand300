...
public class MemServiceImpl implements MemService {
  ...
  @Override
  public int selectDeptListCnt(ComParam param) {
    return memMapper.selectDeptListCnt(param);
  }
  ...
  @Override
  public int selectPosListCnt(ComParam param) {
    return memMapper.selectPosListCnt(param);
  }
