...
public interface MethodMapper {
  ...
  public void deleteRsSub(@Param("rsSeq") int rsSeq,
      @Param("MethodRsSubList") List<MethodRsSub> sDItems);
  ...
  public void deleteEftSub(@Param("eftSeq") int eftSeq,
      @Param("MethodEftSubList") List<MethodEftSub> sDItems);
  ...
  public void deleteSurgeSub(@Param("surgeSeq") int surgeSeq,
      @Param("MethodSurgeSubList") List<MethodSurgeSub> sDItems);
  ...
  public void deleteCsSub(@Param("csSeq") int csSeq,
      @Param("MethodCsSubList") List<MethodCsSub> sDItems);
