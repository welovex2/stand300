...
public class MethodSurge {
	...
	@Column
	private String powerLnEtc;


	@ApiModelProperty(value="교류전원_ETC ", example = "")
	@Column
	private int powerLnEtcYn;
	...
	@ApiModelProperty(value="교류전원_TEXT ", example = "")
	@Column
	private int powerEct1Yn;


	@ApiModelProperty(value="교류전원_TEXT ", example = "")
	@Column
	private int powerEct2Yn;


	@ApiModelProperty(value="교류전원_TEXT ", example = "")
	@Column
	private int powerEct3Yn;


	@ApiModelProperty(value="교류전원_TEXT ", example = "")
	@Column
	private int powerEct4Yn;


	@ApiModelProperty(value="교류전원_TEXT ", example = "")
	@Column
	private int powerEct5Yn;


	@ApiModelProperty(value="교류전원_TEXT ", example = "")
	@Column
	private int powerEct6Yn;


	@ApiModelProperty(value="교류전원_TEXT ", example = "")
	@Column
	private String powerEct1;


	@ApiModelProperty(value="교류전원_TEXT ", example = "")
	@Column
	private String powerEct2;


	@ApiModelProperty(value="교류전원_TEXT ", example = "")
	@Column
	private String powerEct3;


	@ApiModelProperty(value="교류전원_TEXT ", example = "")
	@Column
	private String powerEct4;


	@ApiModelProperty(value="교류전원_TEXT ", example = "")
	@Column
	private String powerEct5;


	@ApiModelProperty(value="교류전원_TEXT ", example = "")
	@Column
	private String powerEct6;
	...
	@ApiModelProperty(value="직류전원_TEXT ", example = "")
	@Column
	private String dcPowerText;


	@ApiModelProperty(value="신호선1 ", example = "")
	@Column
	private String sgnl1;


	@ApiModelProperty(value="신호전2 ", example = "")
	@Column
	private String sgnl2;


	@ApiModelProperty(value="교류전원_LN_CODE ", example = "A")
	@Column
	private String powerLnCode;


	@ApiModelProperty(value="교류전원_LPE_CODE ", example = "B")
	@Column
	private String powerLpeCode;


	@ApiModelProperty(value="교류전원_ETC_CODE ", example = "C")
	@Column
	private String powerEct1Code;


	@ApiModelProperty(value="교류전원_ETC_CODE ", example = "A")
	@Column
	private String powerEct2Code;


	@ApiModelProperty(value="직류전원_PN_CODE ", example = "B")
	@Column
	private String dcPowerPnCode;


	@ApiModelProperty(value="직류전원_ETC_CODE ", example = "C")
	@Column
	private String dcPowerEtcCode;


	@ApiModelProperty(value="신호선1_CODE ", example = "A")
	@Column
	private String sgnl1Code;


	@ApiModelProperty(value="신호전2_CODE ", example = "B")
	@Column
	private String sgnl2Code;
