...
//    	LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
    ...
    public BasicResponse cnsAdd(@ApiParam(value = "상세조회후 메모추가시 상담서고유번호(cnsSeq) 필수", required = true, example = "") @RequestBody CnsDTO.Req cns
    								) throws Exception{
    ...
    public BasicResponse cnsDetail(@ApiParam(value = "상담서 고유번호", required = true, example = "6") @PathVariable(name = "cnsSeq") int cnsSeq) throws Exception{
    ...
    public BasicResponse makeCns(@ApiParam(value = "quoId 또는 sbkId 값만 전송") @RequestBody CnsDTO.Req req) throws Exception{
