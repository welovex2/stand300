...
//	@Pattern(regexp = "^[a-zA-Z0-9+-\\_.]+@[a-zA-Z0-9-]+\\.[a-zA-Z0-9-.]+$", message = "이메일을 확인하세요.") 
	...
	@ApiModelProperty(value="전기정격V ", example = "전기정격V")
	@Column
	private String elctrRtngV;


	@ApiModelProperty(value="전기정격Hz ", example = "전기정격Hz")
	@Column
	private String elctrRtngHz;


	@ApiModelProperty(value="전기정격A ", example = "전기정격A")
	@Column
	private String elctrRtngA;
